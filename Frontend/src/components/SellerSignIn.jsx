...
function SellerSignIn() {
    ...
    return (
        < >
            ...
            <div className="bg-primary lg:h-[88.9vh] h-auto w-[100%] flex justify-center font-playfair">
                <div className="w-[90%] flex flex-col pt-8 items-center justify-start">
                    <div className="rounded-[35px] bg-slate-200 sm:w-[70%] w-[100%] lg:h-[68vh] h-auto  flex flex-col sm:gap-1 gap-4 p-8">
